...
class BenchletOpticalModel(OpticalModel):
    """An example optical model for use with the example testbed "Benchlet".

    This class simulates a simple pupil mask and simple science camera. All parameters are read from
    the simulator configuration file, benchlet/config/simulator.yml.
    """
