...
![Core-to-core latency measurements for Event notifications across Windows, Linux, and macOS operating systems, demonstrating consistent sub-millisecond (TODO CHECK WITH FIGURE) performance. TODO: DESCRIBE FIGURE\label{fig:performance}](figure2_performance.png)
...
![End-to-end latency measurements for a typical adaptive optics control loop: wavefront sensor acquisition, processing, and deformable mirror command output.TODO: DESCRIBE MEASUREMENTS AND FIGURE.\label{fig:timing}](figure3_timing.png)
...
The authors thank the broader HiCAT team and the Space Telescope Science Institute for supporting this development. This work was supported by NASA blah blah blah @REMI
