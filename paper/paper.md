...
![End-to-end latency measurements for a typical adaptive optics control loop: wavefront sensor acquisition, processing, and DM command output.  Timing shown for Windows OS on the HiCAT testbed.
