...
This package makes use of the Control and Automation for Testbeds Kit 2 (CATKit2) package [catkit2](https://github.com/spacetelescope/catkit2) [(Por et. al. 2024)](https://doi.org/10.5281/zenodo.11395554).

CATKit2 (Copyright (c) 2020, AURA All rights reserved) is licensed under a [BSD-3-Clause license](https://opensource.org/license/bsd-3-clause). 
...
* TODO - add the AURA copyright in here 
